...
public enum DetectionErrorCode implements Classifiable {
    ...
    INVALID_MEDIA_FILE_ID("INVALID_MEDIA_FILE_ID"),
    INVALID_USER_ID("INVALID_USER_ID"),
    MEDIA_FILE_NOT_FOUND("MEDIA_FILE_NOT_FOUND"),
    DETECTION_RESULT_NOT_FOUND("DETECTION_RESULT_NOT_FOUND"),
    ...
    // Report-specific errors (for PDF report generation)
    FAILED_TO_GENERATE_REPORT("FAILED_TO_GENERATE_REPORT"),
    INVALID_MEDIA_FILE("INVALID_MEDIA_FILE"),
    PDF_GENERATION_ERROR("PDF_GENERATION_ERROR"),
    EMPTY_REPORT_GENERATED("EMPTY_REPORT_GENERATED"),
    REPORT_FILE_TOO_LARGE("REPORT_FILE_TOO_LARGE"),
    ...
    FAILED_TO_GENERATE_STATS("FAILED_TO_GENERATE_STATS"),
    INVALID_SETTINGS("INVALID_SETTINGS"),
    FAILED_TO_GENERATE_ANALYTICS("FAILED_TO_GENERATE_ANALYTICS"),
